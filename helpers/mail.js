...
export const sendMembersTargetPackageAdminMail = async ({
  memberData,
  new_ids = [],
  level,
}) => {
...
export const sendRepeatMail = (user) => {
  const EMAIL_ASSET_BASE_URL = "https://rightshadow.in/server/public/email";
            ...
            <tr>
              <td style="padding: 5px 20px">
                <table width="100%" style="margin-bottom: 6px">
                  ...
                  <tr>
                    <td align="start">welcome to the Right Shadow - Repeat</td>
                  </tr>
                  <tr>
                    <td align="center">
                      <table
...
export const sendRepeatAdminMail = (user) => {
  const EMAIL_ASSET_BASE_URL = "https://rightshadow.in/server/public/email";
...
export const sendMemberRepeatPackageMail = async ({
  memberData,
  new_ids = [],
  level,
}) => {
...
<html lang="en">
  ...
  <body style="margin:0;padding:0;background:#fff;font-family:Arial,sans-serif;font-size:14px">
    <table width="100%" cellpadding="0" cellspacing="0" style="background:#fff">
      <tr>
        <td align="center">
          <table style="max-width:800px;color: #5b4000;
              background-color: #ffd878;
...
export const sendMembersRepeatPackageAdminMail = async ({
  memberData,
  new_ids = [],
  level,
}) => {
          ...
          <table style="max-width:800px;color: #5b4000;
            ...
            <tr>
              <td style="padding-bottom:5px">
                <div style="display:flex;align-items:center;gap:15px">
                  <img src="${EMAIL_ASSET_BASE_URL}/tt6.jpg" width="48" height="48" />
                  <span style="font-size:18px;font-weight:bold;font-style:italic">REPEAT</span>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td style="padding: 5px 20px">
                <table width="100%" style="margin-bottom: 6px">
                  ...
                  <tr>
                    <td align="start">welcome to the Right Shadow - Focus</td>
                  </tr>
                  <tr>
                    <td align="center">
                      <table
...
`;
  ...
  var mailOptions = {
    from: process.env.SENDER_MAIL,
    to: user.email,
    subject: "Welcome to Right Shadow (Focus Plan)",
    html: mailContent,
  };
...
export const sendFSAdminMail = (user) => {
  const EMAIL_ASSET_BASE_URL = "https://rightshadow.in/server/public/email";
            ...
            <tr>
              <td style="padding: 5px 20px">
                <table width="100%" style="margin-bottom: 6px">
                  ...
                  <tr>
                    <td align="start">
                      welcome to the Right Shadow - Focus
                    </td>
                  </tr>
                  <tr>
                    <td align="center">
...
`;
  ...
  const mailOptions = {
    from: process.env.SENDER_MAIL,
    to: process.env.ADMIN_MAIL_FOCUS,
    subject: `Approved Focus Plan  Members - ${dayjs().format("DD-MM-YYYY")}`,
    html: membersHtml,
  };
...
export const sendMemberFSPackageMail = async ({
  memberData,
  new_ids = [],
  level,
}) => {
  try {
    ...
    const mailContent = `<html lang="en">
  <head>
    <meta charset="UTF-8" />
    <title>Package Added</title>
  </head>
          ...
          <table style="max-width:800px;color: #000;
            ...
            <tr>
              <td style="padding-bottom:5px">
                <div style="display:flex;align-items:center;gap:15px">
                  <img src="${EMAIL_ASSET_BASE_URL}/tt6.jpg" width="48" height="48" />
                  <span style="font-size:18px;font-weight:bold;font-style:italic">FOCUS</span>
                </div>
              </td>
            </tr>
  ...
  <td style="padding-top:2px">
    ...
    const info = await transporter.sendMail({
      from: `"Right Shadow" <${process.env.SENDER_MAIL}>`,
      to: recipient,
      subject: "New Package Member Added (Focus)",
      html: mailContent,
    });
...
export const sendMembersFSPackageAdminMail = async ({
  memberData,
  new_ids = [],
  level,
}) => {
            ...
            <tr>
              <td style="padding: 5px 20px">
                <table width="100%" style="margin-bottom: 6px">
                  ...
                  <tr>
                    <td align="start">
                      welcome to the Right Shadow - KERCHIEF
                    </td>
                  </tr>
                  <tr>
                    <td align="center">
...
`;
  ...
  var mailOptions = {
    from: process.env.SENDER_MAIL,
    to: user.email,
    subject: "Welcome to Right Shadow (Kerchief Plan)",
    html: mailContent,
  };
...
export const sendKRAdminMail = (user) => {
  const EMAIL_ASSET_BASE_URL = "https://rightshadow.in/server/public/email";
...
`;
  ...
  const mailOptions = {
    from: process.env.SENDER_MAIL,
    to: process.env.ADMIN_MAIL_KERCHIEF,
    subject: `Approved Kerchief Plan  Members - ${dayjs().format("DD-MM-YYYY")}`,
    html: membersHtml,
  };
...
export const sendMemberKRPackageMail = async ({
          ...
          <table style="max-width:800px;color: #000;
            ...
            <tr>
              <td style="padding-bottom:5px">
                <div style="display:flex;align-items:center;gap:15px">
                  <img src="${EMAIL_ASSET_BASE_URL}/tt6.jpg" width="48" height="48" />
                  <span style="font-size:18px;font-weight:bold;font-style:italic">KERCHIEF</span>
                </div>
              </td>
            </tr>
  ...
  <td style="padding-top:2px">
    ...
    const info = await transporter.sendMail({
      from: `"Right Shadow" <${process.env.SENDER_MAIL}>`,
      to: recipient,
      subject: "New Package Member Added (Kerchief)",
      html: mailContent,
    });
...
export const sendMembersKRPackageAdminMail = async ({
  memberData,
  new_ids = [],
  level,
}) => {
